...
namespace Concert400
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            var connectionString = $"server={Environment.GetEnvironmentVariable("server")};user={Environment.GetEnvironmentVariable("user")};password={Environment.GetEnvironmentVariable("password")};default database=CONCERTEF";
